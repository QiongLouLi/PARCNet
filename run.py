...
parser.add_argument('--model', type=str, required=False, default='PARCNet',
                    help='model name, options: [PARCNet...]')
...
parser.add_argument('--loss_mode', type=str, default='L1',choices=['L1', 'L2', 'L1L2', 'MAPE', 'MASE', 'SMAPE'])
